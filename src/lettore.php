      ...
      <div class="card text-center">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Codice fiscale:</strong> <?= $_SESSION['codice_fiscale']
            ?><br />
            <strong>Data di nascita:</strong> <?= $_SESSION['data_nascita']
            ?><br />
            <strong>Età:</strong>
        ...
        <div class="position-relative">
          ...
          >
            ...
            <div class="card me-3" style="min-width: 200px; max-width: 200px">
              ...
              />
              <div class="card-body">
                <h5 class="card-title">Titolo <?= $i ?></h5>
                <p class="card-text text-muted">Autore <?= $i ?></p>
              </div>
            </div>
            <?php endfor; ?>
          </div>
